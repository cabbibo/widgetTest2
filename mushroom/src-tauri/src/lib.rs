// Mushroom widget backend. Audio-reactivity (system audio FFT) and global keypress
// monitoring live here because they're mushroom-specific; everything reusable
